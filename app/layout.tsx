...
import { Playfair_Display, Dancing_Script, Space_Grotesk, VT323 } from "next/font/google"
import "./globals.css"
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${playfairDisplay.variable} ${dancingScript.variable} ${spaceGrotesk.variable} ${vt323.variable} ${vt323.className}`}>
